 ...
 /*-----------------------------------------------------------------------------*/
    ...
    public void getPendingOrder() throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                //2. Create SQL String 
                String sql = "SELECT [Order].id, CustomerEmail, [User].Address, [User].PhoneNumber, [User].FullName, [Order].Status, SaleEmail, CompleteDate, TotalOrderPrice, [Order].ShippingPrice, [Order].Paid  "
    ...
    public void getCompletedOrder() throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                ...
                String sql = "SELECT [Order].id, CustomerEmail, [User].Address, [User].PhoneNumber, [User].FullName, [Order].Status, SaleEmail, CompleteDate, TotalOrderPrice, [Order].ShippingPrice, [Order].Paid  "
                        + "FROM [Order] JOIN [User] ON [Order].CustomerEmail = [User].Email "
                        + "WHERE [Order].Status = 'completed' ORDER BY CompleteDate DESC ";
                //3, Create statement & assign value to parameter
                stm = con.prepareStatement(sql);
                //4. Execute Query
                rs = stm.executeQuery();
    ...
    public void getCancelOrder() throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                ...
                String sql = "SELECT [Order].id, CustomerEmail, [User].Address, [User].PhoneNumber, [User].FullName, [Order].Status, SaleEmail, CompleteDate, TotalOrderPrice, [Order].ShippingPrice, [Order].Paid "
                        + "FROM [Order] JOIN [User] ON [Order].CustomerEmail = [User].Email "
                        + "WHERE [Order].Status = 'cancel' ORDER BY CompleteDate DESC";
                //3, Create statement & assign value to parameter
                stm = con.prepareStatement(sql);
                //4. Execute Query
                rs = stm.executeQuery();
 ...
 /*-----------------------------------------------------------------------------*/
    public OrderSaleDTO getOrderById(int orderId) throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                //2. Create SQL String 
                String sql = "SELECT [Order].id, CustomerEmail, [Order].Address, [User].PhoneNumber, [User].FullName, [Order].Status, SaleEmail, CompleteDate, TotalOrderPrice, [Order].ShippingPrice, [Order].Paid "
                        + "FROM [Order] JOIN [User] ON [Order].CustomerEmail = [User].Email "
                        + "WHERE [Order].id = ? ";
                //3, Create statement & assign value to parameter
                stm = con.prepareStatement(sql);
